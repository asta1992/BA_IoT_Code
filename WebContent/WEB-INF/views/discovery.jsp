...
<script src="../smartmanager/resources/js/smartmanager/discovery.js" type="text/javascript"></script>
<script src="../smartmanager/resources/js/smartmanager/groupManagement.js" type="text/javascript"></script>
</head>
<body>
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<h3>
					Discovery 
					<span class="pull-right"><button class="btn btn-default btn-lg" onclick="location.href='/smartmanager/discovery/clean';">
