...
<link rel="stylesheet"
	...
	type="text/css">
<link rel="stylesheet"
	href="..${pageContext.request.contextPath}/resources/css/lib/metisMenu.min.css"
	type="text/css">
<link rel="stylesheet"
		...
		<div class="col-md-4 col-md-offset-4">
			<div class="login-panel panel panel-default">
				...
				<div class="panel-body">
					<form role="form" class="form-signin" name='f'
						action='${pageContext.request.contextPath}/j_spring_security_check'
						method='POST'>
						<fieldset>
							<div class="form-group">
								<input type="text" id="username" name="j_username" value=''
									class="form-control" placeholder="Username" type="email"
									required autofocus>
							</div>
							<div class="form-group">
						...
						<button class="btn btn-lg btn-primary btn-block"
							name="submit" type="submit" value="Login">Sign in</button>
					</form>
				</div>
			</div>
			<button class="btn btn-lg btn-primary btn-block"
				...
				<div class="bs-example">
					<div class="alert alert-danger fade in">
						<a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Login
							failure!</strong> Please try it again.
					</div>
				</div>
			</c:if>
			<c:if test="${param.logout != null}">
				<div class="bs-example">
					<div class="alert alert-success fade in">
						<a href="#" class="close" data-dismiss="alert">&times;</a> <strong>Log
							out complete.</strong>
					</div>
				</div>
			</c:if>
